...
var environment = {
  ...
  twitter: {
    ...
    rateLimit: {
      ...
      // OAuth 1.0a user context limit
      windowDurationMs: 15 * 60 * 1e3,
      // 15 minutes
      monthlyLimit: 100
    ...
    enableEmbed: true,
    enableApi: false,
    // Disabled due to CORS limitations
  ...
  features: {
    ...
    twitterApiEnabled: false,
    // Disabled due to CORS limitations in browser
    twitterEmbedEnabled: true,
    // Primary solution - no CORS issues
    analytics: false,
    debugMode: true
  },
  // Debug settings
...
//# sourceMappingURL=chunk-R6D4IH7D.js.map
